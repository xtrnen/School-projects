 ...
 * Date: 24.11.2018
 * Time: 10:07
 * potrebuje: ID_vybaveni_typ, ucinek, rozsah, potrebna_uroven
...
$query =
    "INSERT INTO past (ID_vybaveni_typ, ucinek, rozsah) VALUES('".$_POST['ID_vybaveni_typ']."','".$_POST['ucinek']."','".$_POST['rozsah']."')";
$conn->query($query);
