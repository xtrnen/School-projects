 ...
 * Date: 24.11.2018
 * Time: 10:07
 * potrebuje: ID_vybaveni_typ, poskozeni, opotrebeni, potrebna_uroven
...
$query =
    "INSERT INTO zbran(ID_vybaveni_typ, poskozeni, opotrebeni) VALUES('".$_POST['ID_vybaveni_typ']."','".$_POST['poskozeni']."','".$_POST['opotrebeni']."')";
$conn->query($query);
